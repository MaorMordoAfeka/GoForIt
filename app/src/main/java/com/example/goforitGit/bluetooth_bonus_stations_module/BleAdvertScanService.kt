package com.example.goforitGit.bluetooth_bonus_stations_module
...
class BleAdvertScanService : Service() {
    ...
    @Volatile private var lastResultAtMs: Long = 0L
    @Volatile private var lastSeenMsg: String? = null
    @Volatile private var lastToastAtMs: Long = 0L
    ...
    private fun buildNotification(text: String): Notification {
        val launchIntent = Intent(this, com.example.goforitGit.MainActivity::class.java).apply {
    ...
    private fun safeDeviceName(record: android.bluetooth.le.ScanRecord): String? {
    ...
    companion object {
        ...
        private fun showResumeNotification(context: Context, text: String) {
            ...
            val pi = PendingIntent.getActivity(
                context,
                0,
                Intent(context, com.example.goforitGit.MainActivity::class.java).apply {
                    action = "ACTION_REQUEST_BLE_PERMISSIONS"
                    flags = Intent.FLAG_ACTIVITY_NEW_TASK or Intent.FLAG_ACTIVITY_CLEAR_TOP
                },
                PendingIntent.FLAG_UPDATE_CURRENT or PendingIntent.FLAG_IMMUTABLE
